...
final class ContactValue extends Data
{
     ...
     *
     * @param null|string $name  The identifying name of the contact person or organization
     *                           responsible for the API. This could be a person's name,
     *                           team name, or organization name that API users can
     *                           reference when seeking support or information.
     * @param null|string $url   URL pointing to the contact information or support page.
     *                           This could be a website, documentation page, or any other
     *                           URL that provides additional contact information or
     *                           support resources for API users.
     * @param null|string $email Email address for contacting the API maintainers or
     *                           support team. This should be a monitored email address
     *                           where API users can send questions, bug reports, or
     *                           feedback about the API specification or implementation.
     */
