...
final class ServerVariableValue extends Data
{
     ...
     *
     * @param array<int, string> $enum        Array of enumerated values that restrict the allowed
     *                                        values for this server variable. When specified, the
     *                                        variable value must be one of the provided options,
     *                                        enabling controlled server configuration choices and
     *                                        validation against a predefined set of values.
