...
final readonly class CursorPaginatorContentDescriptor
{
     ...
     * validation rules for cursor-based pagination parameters in RPC methods.
     * The descriptor references a reusable CursorPaginator schema component that
     * contains detailed field definitions for cursor tokens, page sizes, and
     ...
     *
     * @return array{name: string, description: string, schema: array{'$ref': string}} OpenRPC content descriptor array with name, description, and schema reference to the CursorPaginator component
     */
